...
>     ::: add
>
>     For a subexpressions `tag` and `env`, the lambda expression above returns an object `attrs` such
>     that
>
>     - [10.1]{.pnum} `get_completion_domain<tag>(attrs, env)` is expression-equivalent
