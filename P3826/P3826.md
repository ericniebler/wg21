...
>
>      > ```cpp
>      > @_`COMMON-DOMAIN`_@(@_`COMPL-DOMAIN`_@(@_`set-cpo`_@, child, @_`FWD-ENV`_@(as)...),
>      >               @_`COMPL-DOMAIN`_@(set_value, child, @_`FWD-ENV`_@(as)...))
>      > ```
>
...
>      > ```cpp
>      > @_`COMMON-DOMAIN`_@(@_`COMPL-DOMAIN`_@(@_`set-cpo`_@, child, @_`FWD-ENV`_@(as)...),
>      >               @_`COMPL-DOMAIN`_@(set_error, child, @_`FWD-ENV`_@(as)...))
>      > ```
>
