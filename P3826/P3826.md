...
> - [2]{.pnum} The names `just`, `just_error`, and `just_stopped` denote customization point
...
> - [3]{.pnum} The exposition-only class template _`impls-for`_ ([exec.snd.expos]{.sref}) is
